    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
      <div className="mb-3 flex items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center rounded-xl border border-dashed border-blue-300 px-3 py-2 text-sm font-bold text-blue-600 hover:bg-blue-50"
        >
      ...
      {members.some((member) => member.isLegacyMember) && (
        <div className="mb-4 rounded-xl bg-amber-50 p-3 text-sm font-medium text-amber-700">
          This team has old member data. Click Manage people, select people from your People list, and save the team.
        </div>
      )}
      ...
      <div className="flex flex-wrap gap-2">
        {members.map((member) => (
          <div
            ...
            className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-gray-50 px-2 py-1.5 text-sm font-semibold text-gray-700 hover:border-blue-300 hover:bg-blue-50"
          >
            <button
              type="button"
