    ...
    <header className="bg-white/80 backdrop-blur-md border-b border-gray-100/80 shadow-sm z-20">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-3 w-full">
          {/* Left Section - small spacer / brand area */}
          <div className="flex items-center">
            {/* keep this empty for now or add brand/logo later */}
          </div>

          {/* Right Section - Team Selector (before user) + User Menu */}
          <div className="flex items-center space-x-3">
            {/* Team Selector moved to the right side */}
            {teams.length > 0 && (
            ...
            <div className="relative">
              ...
              {showUserMenu && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-2 w-64 bg-white/95 backdrop-blur-md rounded-xl shadow-lg border border-gray-100/80 py-2 z-20 animate-in fade-in slide-in-from-top-2 duration-200">
